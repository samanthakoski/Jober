...
public class SetLocationFragment extends Fragment implements OnMapReadyCallback {
    ...
    private String BACK_STACK_TAG_ROOT;
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        BACK_STACK_TAG_ROOT = frag.getBackStackTag();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                activity.getFragManager().popBackStack(BACK_STACK_TAG_ROOT,
